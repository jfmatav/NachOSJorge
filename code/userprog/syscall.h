...
/* SemCreata creates a semaphore initialized to initval value
...
/* Run the executable, stored in the Nachos file "name", using the number of 
 * parameters detailes in argc, and the parameters in argv, and return the 
 * address space identifier
 */
/*SpaceId Exec(char *name, int argv, char* argv );*/
