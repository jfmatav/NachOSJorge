...
SynchDisk   *synchDisk;
 ...
 BitMap  *BitMapMemory;   // BitMap, Memory management
 NachosThreads* myThreads;
 Swap * SwapFile;
...
// 2007, Jose Miguel Santos Espino
    ...
    BitMapMemory = new BitMap (NumPhysPages); // BitMap que controla la indización de la memoria. 
    myThreads = new NachosThreads();		//Table of threads
    SwapFile= new Swap();
